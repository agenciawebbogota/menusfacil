            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:50px"><p style="color:#2b2831; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif"><strong>Hola, </strong><strong style="text-transform:uppercase;">{{$usuario->name}}</strong></p>
                      <p style="font-size:16px; text-align:left; line-height:22px ">Aviso importante. <br>Queremos informarle que le quedan <strong>{{$dias}} </strong> días para que caduque la suscripción gratuita.</p>
                      ...
                      <table border="0" align="left" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
												<tbody>
														<tr>
															<td>
																<p style="font-size:16px; text-align:left; line-height:22px ">¿Necesita ayuda? Puedes comunicarte con nosotros y con el mayor de los gustos te atedemos.</p></td>
