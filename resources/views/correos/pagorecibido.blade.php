{{-- <p>{{$pago->correo_comprador}}</p>
<p>{{$pago->medio_pago}}</p>
<p>Código de respuesta PAYU: {{$pago->codigo_respuesta_payu}}</p>
<p>id del comprador: {{$pago->user_id}}</p> --}}
            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;">
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:50px"><p style="color:#2b2831; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif"><strong>¡Excelente! </strong></p>
                      <p style="font-size:16px; text-align:left; line-height:22px ">Tu pago ha sido recibido y confirmado <br></p>
											<p>Ahora puedes continuar disfrutando de todas las funciones de Menús Fácil</p>
                  </tr>
                </table>
