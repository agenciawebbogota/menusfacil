...
<body>
  ...
  @endif
    ...
    <ul id="slide-out" class="sidenav">
      ...
      <li><div class="divider"></div></li>
      <li><a href="/admin/facturacion">Actualizar Cuenta<i class="material-icons">autorenew</i></a></li>
      <li><div class="divider"></div></li>
      <li><a href="/admin/crear-sucursal">Crear Sucursal<i class="material-icons">where_to_vote</i></a></li>
      <li><div class="divider"></div></li>
    </ul>
