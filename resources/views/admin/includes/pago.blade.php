...
<div class="row">
  <div class="img-pago">
    ...
      <input type="image" border="0" alt="" src="http://agenciawebbogota.com/social/boton-pagar.png" />
    ...
      <input name="lng" type="hidden" value="es"/>
      <input name="responseUrl"    type="hidden"  value="{{url('respuesta')}}" >
      <input name="confirmationUrl"    type="hidden"  value="{{url('confirmacion')}}" >
