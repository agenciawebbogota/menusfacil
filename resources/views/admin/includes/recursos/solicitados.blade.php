<div class="card" style="height:520px;background-color: {{Auth::user()->color1}}">
	<div class="card-image">
		<a href="{{url('/admin/ordenes')}}" target="_blank" class="btn-floating halfway-fab waves-effect waves-light tooltipped" data-position="button" data-tooltip="Ver ordenes" style="background-color:{{Auth::user()->color3}} !important;"><i class="material-icons">visibility</i></a>
