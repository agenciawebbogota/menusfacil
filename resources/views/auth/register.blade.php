                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row"> --}}
                            ...
                            {{-- <div class="col-md-6"> --}}
                                <input id="color1" type="hidden"  name="color1" value="#1c8076" {{--required autofocus v-model="datos.color1"--}}>
                        ...
                        <div class="form-group row"> --}}
                            ...
                            {{-- <div class="col-md-6"> --}}
                                 <input id="color2" type="hidden" name="color2" value="#ed2a26">
                         ...
                         <div class="form-group row"> --}}
                            ...
                            {{-- <div class="col-md-6"> --}}
                                <input id="color3" type="hidden" name="color3" value="#fcc232">
