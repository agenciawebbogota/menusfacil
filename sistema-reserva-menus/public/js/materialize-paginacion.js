$.fn.pageMe = function(opts){
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="prev_link" title="'+settings.prevText+'"><i class="mdi-navigation-chevron-left"></i></a></li>').appendTo(pager);
    }
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="next_link"  title="'+settings.nextText+'"><i class="mdi-navigation-chevron-right"></i></a></li>').appendTo(pager);
    }
