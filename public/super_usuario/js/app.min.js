...
!function (t) {
  if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module) module.exports = t(), module.exports.introJs = function () {
...
new Vue({
  ...
  mounted: function mounted() {
    document.addEventListener('DOMContentLoaded', function () {
      ...
      var actualizarUser = M.Modal.init(document.querySelectorAll('#actualizarUser'), { dismissible: false });
  ...
  methods: {
    getUsers: function getUsers() {
      ...
      axios.get('usuarios/get').then(function (resp) {
        _this2.usuarios = resp.data;
        // console.log(resp.data);
      }).catch(function (error) {});
    },
    actualizarUser: function (_actualizarUser) {
      function actualizarUser() {
        return _actualizarUser.apply(this, arguments);
      }

      actualizarUser.toString = function () {
        return _actualizarUser.toString();
      };
      ...
      axios.put(url, this.update).then(function (resp) {
        _this3.getUsers();
        var modalupdate = M.Modal.getInstance(actualizarUser);
        modalupdate.close();
        M.toast({
          html: 'Se ha actualizado el usuario ' + "'" + _this3.update.name + "'.",
          outDuration: 1000
        });
      }).catch(function (error) {});
    }),
    actualizarDias: function actualizarDias() {
      var _this4 = this;

      axios.put('/usuarios/actualizardias', { data: true }).then(function (resp) {
        _this4.getUsers();
        M.toast({
    ...
    llenarModal: function llenarModal(usuario) {
      this.update = usuario;
    },
    hora: function hora() {
      // console.log('algo');
    ...
    //   })
    // },
    vistaGuiada: function vistaGuiada() {
      // Intro de la web
      introJs().start();
      introJs().addStep([{
