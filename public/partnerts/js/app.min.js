...
new Vue({
  ...
  methods: {
    registrar: function registrar() {
      ...
      if (this.partnert.nombre.length < 3) {
        ...
        if (buscado != undefined) {
          ...
          var url = '';
          axios.post(url, this.partnert).then(function (resp) {
            M.toast({
    ...
    getPartnerts: function getPartnerts() {
      var _this2 = this;

      var url = '/partnerts/get';
      axios.get(url).then(function (resp) {
        resp.data.map(function (partnert) {
          _this2.correos.push(partnert.correo);
        });
      });
    }
  }
